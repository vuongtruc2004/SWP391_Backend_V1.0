    ...
    private void createLesson() {
        if (!lessonRepository.existsBy()) {
            List<LessonEntity> lessons = List.of(
                    LessonEntity.builder().title("Giới thiệu về Java").build(),
                    LessonEntity.builder().title("Lập trình hướng đối tượng").build(),
                    LessonEntity.builder().title("Cấu trúc dữ liệu và giải thuật").build(),
                    LessonEntity.builder().title("Làm việc với MySQL").build(),
                    LessonEntity.builder().title("Spring Boot cơ bản").build(),
                    LessonEntity.builder().title("RESTful API với Spring Boot").build(),
                    LessonEntity.builder().title("Bảo mật Spring Boot").build(),
                    LessonEntity.builder().title("Làm việc với Hibernate").build(),
                    LessonEntity.builder().title("Lập trình Web với React").build(),
                    LessonEntity.builder().title("Kết nối Frontend và Backend").build(),
                    LessonEntity.builder().title("Redux trong React").build(),
                    LessonEntity.builder().title("Next.js và SSR").build(),
                    LessonEntity.builder().title("CI/CD với GitHub Actions").build(),
                    LessonEntity.builder().title("Docker và Kubernetes").build(),
                    LessonEntity.builder().title("Microservices với Spring Cloud").build(),
                    LessonEntity.builder().title("GraphQL trong Java").build(),
                    LessonEntity.builder().title("Lập trình Android với Kotlin").build(),
                    LessonEntity.builder().title("Machine Learning với Python").build(),
                    LessonEntity.builder().title("Advanced Java Programming").build(),
                    LessonEntity.builder().title("TDD với JUnit").build(),
                    LessonEntity.builder().title("Bộ nhớ đệm với Redis").build(),
                    LessonEntity.builder().title("Kafka và Event-Driven Architecture").build(),
                    LessonEntity.builder().title("Xây dựng API GraphQL").build(),
                    LessonEntity.builder().title("OAuth2 và OpenID Connect").build(),
                    LessonEntity.builder().title("WebSockets với Spring Boot").build(),
                    LessonEntity.builder().title("Elasticsearch cho Big Data").build(),
                    LessonEntity.builder().title("Golang cho Backend Developers").build(),
                    LessonEntity.builder().title("TensorFlow với Java").build(),
                    LessonEntity.builder().title("Xây dựng hệ thống CI/CD nâng cao").build(),
                    LessonEntity.builder().title("Xây dựng ứng dụng Serverless").build(),
                    LessonEntity.builder().title("Biến và kiểu dữ liệu trong Java").build(),
                    LessonEntity.builder().title("Cấu trúc điều kiện và vòng lặp").build(),
                    LessonEntity.builder().title("Lập trình hướng đối tượng với Java").build(),
                    LessonEntity.builder().title("Làm việc với Array và Collection").build(),
                    LessonEntity.builder().title("Xử lý ngoại lệ trong Java").build(),
                    LessonEntity.builder().title("Làm việc với File trong Java").build(),
                    LessonEntity.builder().title("Giới thiệu về JDBC").build(),
                    LessonEntity.builder().title("Lập trình đa luồng trong Java").build(),
                    LessonEntity.builder().title("Xây dựng ứng dụng Java Swing").build(),
                    LessonEntity.builder().title("Làm việc với API trong Java").build(),
                    LessonEntity.builder().title("Spring Boot: Giới thiệu và Cấu hình").build(),
                    LessonEntity.builder().title("Spring Boot: Xây dựng API RESTful").build(),
                    LessonEntity.builder().title("Spring Boot: Làm việc với JPA và MySQL").build(),
                    LessonEntity.builder().title("Spring Security: Xác thực và phân quyền").build(),
                    LessonEntity.builder().title("Dự án thực tế: Xây dựng website bán hàng với Spring Boot").build(),
                    LessonEntity.builder().title("Giới thiệu về Python").build(),
                    LessonEntity.builder().title("Biến và kiểu dữ liệu trong Python").build(),
                    LessonEntity.builder().title("Cấu trúc điều kiện và vòng lặp").build(),
                    LessonEntity.builder().title("Lập trình hướng đối tượng trong Python").build(),
                    LessonEntity.builder().title("Làm việc với List, Tuple, Dictionary").build(),
                    LessonEntity.builder().title("Xử lý file trong Python").build(),
                    LessonEntity.builder().title("Lập trình bất đồng bộ trong Python").build(),
                    LessonEntity.builder().title("Dự án Python: Xây dựng ứng dụng quản lý công việc").build(),
                    LessonEntity.builder().title("Giới thiệu về React.js").build(),
                    LessonEntity.builder().title("React Hooks và State Management").build(),
                    LessonEntity.builder().title("Next.js: Xây dựng ứng dụng SSR và SSG").build(),
                    LessonEntity.builder().title("Xây dựng API với Node.js").build(),
                    LessonEntity.builder().title("Tìm hiểu về TypeScript").build(),
                    LessonEntity.builder().title("Dự án thực tế: Xây dựng website bán hàng với React").build(),
                    LessonEntity.builder().title("Tối ưu hiệu suất với React và Next.js").build()
