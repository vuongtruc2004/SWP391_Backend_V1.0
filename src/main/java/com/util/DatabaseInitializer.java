...
//        createPermission();
    ...
    public void createPermission() {
        List<PermissionEntity> permissions = Arrays.asList(
                ...
                //change password
                new PermissionEntity("/change-password/send-otp", ApiMethodEnum.POST),
                new PermissionEntity("/change-password/new-password", ApiMethodEnum.POST),

                //My courses
                new PermissionEntity("/my-course/{id}", ApiMethodEnum.GET)
